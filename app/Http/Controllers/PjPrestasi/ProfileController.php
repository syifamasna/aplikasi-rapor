...
class ProfileController extends Controller
{
    public function index()
    {
        ...
        return view('pj-prestasi-pages.profile.index', compact('user', 'activeRole'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('pj_prestasi.profile.index')->with('success', 'Profil berhasil diperbarui.');
    }
    ...
    public function destroyImage()
    {
        ...
        return redirect()->route('pj_prestasi.profile.index')->with('success', 'Foto profil berhasil dihapus.');
    }
}
