...
class ClassReportController extends Controller
{
    public function index()
    {
        ...
        return view('admin-pages.class_reports.index', compact('student_classes'));
    }
    ...
    public function show($class_id)
    {
       ...
       $kelas_3_6 = ['III', 'IV', 'V', 'VI'];
        ...
        return view('admin-pages.class_reports.show', compact(
            'class',
            'students',
            'grades',
            'subjects',
    ...
    public function exportPdf($class_id)
    {
       ...
       $kelas_3_6 = ['III', 'IV', 'V', 'VI'];
        ...
        if (request('mode') === 'print') {
            return view('admin-pages.class_reports.show-pdf', compact(
                'class',
                'students',
                'grades',
                'subjects',
        ...
        $pdf = Pdf::loadView('admin-pages.class_reports.show-pdf', compact(
            'class',
            'students',
            'grades',
            'subjects',
    ...
    public function exportAllPdf($class_id, Request $request)
    {
       ...
       $kelas_3_6 = ['III', 'IV', 'V', 'VI'];
        ...
        foreach ($students as $index => $student) {
            ...
            $html = View::make('admin-pages.student_reports.show-pdf', compact(
                'class',
                'student',
                'grades',
                'subjects',
