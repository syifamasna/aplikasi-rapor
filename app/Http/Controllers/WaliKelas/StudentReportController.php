...
class StudentReportController extends Controller
{
    public function index()
    {
        ...
        return view('wali-kelas-pages.student_reports.index', compact('student_classes'));
    }
    ...
    public function students($class_id)
    {
        ...
        return view('wali-kelas-pages.student_reports.students', compact('class', 'students'));
    }
    ...
    public function show($class_id, $student_id)
    {
       ...
       $kelas_3_6 = ['III', 'IV', 'V', 'VI'];
        ...
        return view('wali-kelas-pages.student_reports.show', compact(
