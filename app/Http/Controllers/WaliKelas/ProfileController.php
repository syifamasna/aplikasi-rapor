...
class ProfileController extends Controller
{
    public function index()
    {
        ...
        return view('wali-kelas-pages.profile.index', compact('user', 'activeRole'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('wali_kelas.profile.index')->with('success', 'Profil berhasil diperbarui.');
    }
    ...
    public function destroyImage()
    {
        ...
        return redirect()->route('wali_kelas.profile.index')->with('success', 'Foto profil berhasil dihapus.');
    }
}
