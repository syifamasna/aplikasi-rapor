                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-md-6 p-md-0 d-flex justify-content-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a class="text-dark" href="{{ route('admin.school_years.index') }}">Data Tahun Ajar</a></li>
                        </ol>
                    </div>
                </div>
                ...
                <form id="addSchoolYearForm" action="{{ route('admin.school_years.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tempat_rapor" class="form-control" placeholder="Bogor">
                        </div>
                        <div class="form-group">
