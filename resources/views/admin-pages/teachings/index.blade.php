...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const submitButton = document.querySelector('#addTeachingForm button[type="submit"]');
            const formInputs = document.querySelectorAll('#addTeachingForm input, #addTeachingForm select');
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            $('#editTeachingModal').on('show.bs.modal', function() {
