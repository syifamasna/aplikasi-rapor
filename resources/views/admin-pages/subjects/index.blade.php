...
<body>
            ...
            <div class="modal-content">
                <form id="editSubjectForm" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success" id="editSubmitButton" disabled>Simpan Perubahan</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const formInputs = document.querySelectorAll('#addSubjectForm input, #addSubjectForm select');
