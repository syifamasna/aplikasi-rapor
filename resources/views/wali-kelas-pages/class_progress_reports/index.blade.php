...
<head>
    ...
    <title>Laporan Perkembangan Peserta Didik - E-Rapor SIT Aliya</title>
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-md-6 p-md-0 d-flex justify-content-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">LPPD</a></li>
                        </ol>
                    </div>
                </div>
                                ...
                                <tbody>
                                    @foreach ($student_classes as $student_classes)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('wali_kelas.class_progress_reports.show', ['class_id' => $student_classes->id]) }}"
