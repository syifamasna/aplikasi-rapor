...
<head>
    ...
    <title>Laporan Perkembangan Siswa (LPS) - E-Rapor SIT Aliya</title>
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">LPS</li>
                        </ol>
                    </div>
                </div>
                                ...
                                <tbody>
                                    @foreach ($student_classes as $student_classes)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('wali_kelas.student_progress_reports.students', ['class_id' => $student_classes->id]) }}"
