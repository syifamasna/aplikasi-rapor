...
<head>
    ...
    <title>Laporan Perkembangan {{ $student->nama ?? '-' }} - E-Rapor SIT Aliya
    </title>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <!-- FORM FILTER -->
                        <form
                            action="{{ route('wali_kelas.student_progress_reports.show', ['class_id' => $class->id, 'student_id' => $student->id]) }}"
                            method="GET">
                            ...
                            <div class="mb-4 border-bottom pb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-2 d-flex align-items-center">
                                        <strong class="info-row h5 font-weight-bold me-3 w-25 text-nowrap">Nama Peserta
                                            Didik
                                            <span>:</span></strong>
                                    ...
                                    <!-- NIS/NISN -->
                                    <div class="col-md-12 mb-2 d-flex align-items-center">
                                        <strong class="info-row h5 font-weight-bold me-3 w-25 text-nowrap">NIS / NISN
                                            <span>:</span></strong>
                                        <input type="text" class="form-control flex-grow-1"
                                            value="{{ $student->nis ?? '-' }} / {{ $student->nisn ?? '-' }}" disabled>
                                    </div>
